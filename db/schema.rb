...
ActiveRecord::Schema.define(version: 20170115213250) do
  ...
  create_table "drudges", force: :cascade do |t|
    t.string   "title"
    t.text     "description"
    t.string   "image"
    t.string   "url"
  ...
  create_table "newsapis", force: :cascade do |t|
    t.string   "title"
    t.string   "url"
    t.string   "image"
    t.datetime "created_at", null: false
  ...
  create_table "newyorktimes", force: :cascade do |t|
    t.string   "title"
    t.string   "url"
    t.string   "image"
    t.datetime "created_at", null: false
  ...
  create_table "table_new_york_times", force: :cascade do |t|
    t.string "title"
    t.string "url"
    t.string "image"
  end
